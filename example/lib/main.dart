...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    FlutterMoney fmf = FlutterMoney(amount: 12345678.9012345);
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          '${FlutterMoney(amount: 12345.678).fastCalc(type: FastCalcType.addition, amount: 1.111).fastCalc(type: FastCalcType.substraction, amount: 2.222).output.nonSymbol}',
                          style: subtitleStyle,
                        ),
                      ),
                      ListTile(
